...
export function Conversation({ interviewType, onBack }: ConversationProps) {
  ...
  return (
    <div className="flex flex-col justify-between h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50 text-gray-800">
      {/* Header */}
      <div className="flex justify-between items-center p-6 bg-white border-b border-gray-100">
        ...
        <h1 className="text-2xl font-bold text-center text-[#0E8DE1]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-5xl px-4">
          ...
          <Card className="overflow-hidden h-[450px] relative bg-white border border-gray-200 shadow-lg">
            ...
            <div className="h-full w-full flex items-center justify-center p-6">
              ...
              <div className="relative w-40 h-40 mx-auto flex items-center justify-center">
                {conversation.isSpeaking && conversationStarted ? (
                  ...
                  <div className="audio-line">
                    {Array.from({ length: 16 }).map((_, i) => (
                      <div key={i} className="line-segment bg-[#0E8DE1]" />
                    ))}
                  </div>
                )}
              </div>
              ...
              >
                <div className="relative w-8 h-8 mr-2 rounded-full overflow-hidden border border-[#0E8DE1]">
                  <img
                    src="/thibaut.png"
                ...
                <AnimatedShinyText className="text-[#0E8DE1]">
      ...
      <div className="p-6 bg-white border-t border-gray-100">
        {/* Timer */}
        <div className="text-center text-xl font-mono mb-4 text-[#0E8DE1] font-semibold">
      ...
      <Dialog open={showSynthesisDialog} onOpenChange={setShowSynthesisDialog}>
        <DialogContent className="sm:max-w-lg max-h-[80vh] overflow-y-auto bg-white border border-gray-200 text-gray-800">
          <DialogHeader className="text-center">
            <DialogTitle className="text-2xl font-bold text-[#0E8DE1]">
